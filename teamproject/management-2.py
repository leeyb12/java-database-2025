...
class StudentManagementApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.year_combo.addItems([str(y) for y in range(2000, 2025)])
        ...
        form_layout.addWidget(QLabel("PWD:"))
        form_layout.addWidget(self.pwd_input)

        form_layout.addWidget(QLabel("생년월일:"))
        form_layout.addWidget(self.year_combo)
        form_layout.addWidget(QLabel("년"))
        form_layout.addWidget(self.month_combo)
        form_layout.addWidget(QLabel("월"))
        form_layout.addWidget(self.day_combo)
        form_layout.addWidget(QLabel("일"))
        ...
        self.upload_btn = QPushButton("사진 업로드", self)
        ...
        self.table.setHorizontalHeaderLabels(["이름", "ID", "생년월일", "전화번호", "주소", "학년", "반"])
    ...
    def add_student(self):
        ...
        birthdate = f"{self.year_combo.currentText()}-{self.month_combo.currentText()}-{self.day_combo.currentText()}"
    ...
    def update_student(self):
        ...
        self.students[selected_row] = [
            ...
            self.id_input.text(),
            f"{self.year_combo.currentText()}-{self.month_combo.currentText()}-{self.day_combo.currentText()}",
